...
const page = () => {
return ( <main className="bg-[#0f0f0f] text-white min-h-screen">
{/* 🌟 Hero Section */} <section className="relative py-24 px-6 sm:px-10 lg:px-20 text-center overflow-hidden"> <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(16,185,129,0.15),transparent_70%)]" />
<motion.h1
...
At Trulyzer, technology meets creativity to deliver powerful, user-centric solutions.
  ...
  <section className="py-20 px-6 sm:px-10 lg:px-20 bg-white/5 border-t border-white/10 text-center">
    ...
    >
      To empower businesses and creators through clean, efficient, and scalable digital solutions.
      We believe great design and strong technology can transform how brands connect with their audiences.
    </motion.p>
  </section>
  ...
  <section className="py-20 px-6 sm:px-10 lg:px-20 text-center border-t border-white/10 bg-white/5">
    ...
    >
      We envision a digital future where every business—big or small—has access to high-quality technology that’s intuitive, scalable, and beautifully designed.
    </motion.p>
    ...
    <div className="grid sm:grid-cols-3 gap-8 max-w-5xl mx-auto">
      {[
        ...
        { name: 'Deliver', desc: 'We take pride in every pixel, every line of code, and every outcome.' },
      ].map((v, i) => (
        <motion.div
          key={i}
          initial={{ opacity: 0, y: 40 }}
