...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    description: post.metaDescription || post.excerpt || "Read this insightful post from Trulyzer.",
    keywords: post.tags || ["Trulyzer", "blog", "web development", "design"],
    openGraph: {
      title: `${post.title} | Trulyzer Blog`,
      description: post.metaDescription || post.excerpt || "Explore this insightful Trulyzer article.",
      url,
      siteName: "Trulyzer",
      images: [
        {
