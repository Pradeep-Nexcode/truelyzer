...
const Page = () => {
  ...
  return (
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-lg bg-[#1a1a1a] text-white border border-white/10 focus:border-emerald-400 outline-none transition-all"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                rows="5"
                className="w-full px-4 py-3 rounded-lg bg-[#1a1a1a] text-white border border-white/10 focus:border-emerald-400 outline-none transition-all resize-none"
              />
            </div>
    ...
    ${
      isLoading
        ? "bg-emerald-500/60 cursor-not-allowed shadow-none"
